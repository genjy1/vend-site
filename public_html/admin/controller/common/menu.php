...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_spares'] = "Запчасти";
		$data['text_slider'] = "Слайдер";
		$data['text_gallery'] = "Галерея";
    $data['text_push'] = "Уведомления";
    $data['text_push_history'] = "История push";
    $data['text_mail_history'] = "История mail";
    $data['text_posts'] = "Посты";
    ...
    $data['text_youtube'] = "Youtube";

		$data['analytics'] = $this->url->link('extension/analytics', 'token=' . $this->session->data['token'], true);

    $data['onlinevendshop'] = $this->url->link('extension/onlinevendshop', 'token=' . $this->session->data['token'], true);

    $data['push'] = $this->url->link('extension/notifications', 'token=' . $this->session->data['token'], true);

    $data['push_history'] = $this->url->link('extension/notifications/push_history', 'token=' . $this->session->data['token'], true);
    $data['mail_history'] = $this->url->link('extension/notifications/mail_history', 'token=' . $this->session->data['token'], true);

    $data['youtube'] = $this->url->link('extension/youtube_gallery', 'token=' . $this->session->data['token'], true);

    $data['onlinevendshop'] = $this->url->link('extension/onlinevendshop', 'token=' . $this->session->data['token'], true);

    $data['posts'] = $this->url->link('catalog/post', 'token=' . $this->session->data['token'], true);
		...
		$data['sub'] = $this->url->link('extension/sub', 'token=' . $this->session->data['token'], true);
		...
		$data['spares'] = $this->url->link('catalog/spares', 'token=' . $this->session->data['token'], true);
		$data['gallery'] = $this->url->link('catalog/gallery', 'token=' . $this->session->data['token'], true);
		$data['slider'] = $this->url->link('catalog/slider', 'token=' . $this->session->data['token'], true);
