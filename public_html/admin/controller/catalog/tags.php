...
class ControllerCatalogTags extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('catalog/tags', 'token=' . $this->session->data['token'] . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('catalog/tags', 'token=' . $this->session->data['token'] . $url, true)
		);

		$data['add'] = $this->url->link('catalog/tags/add', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('catalog/tags/delete', 'token=' . $this->session->data['token'] . $url, true);
		$data['settings'] = $this->url->link('catalog/tags/settings', 'token=' . $this->session->data['token'] . $url, true);
		$data['group'] = $this->url->link('catalog/tags/group', 'token=' . $this->session->data['token'] . $url, true);
		...
		foreach ($results as $result) {
			$data['tags'][] = array(
				...
				'name'        => $result['name'],
				'count'	=> $result['count'],
				'edit'        => $this->url->link('catalog/tags/edit', 'token=' . $this->session->data['token'] . '&tag_id=' . $result['tag_id'] . $url, true),
				'delete'      => $this->url->link('catalog/tags/delete', 'token=' . $this->session->data['token'] . '&tag_id=' . $result['tag_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('catalog/tags', 'token=' . $this->session->data['token'] . '&sort=name' . $url, true);
		...
		$pagination->url = $this->url->link('catalog/tags', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['tag_id'])) {
			$data['action'] = $this->url->link('catalog/tags/add', 'token=' . $this->session->data['token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('catalog/tags/edit', 'token=' . $this->session->data['token'] . '&tag_id=' . $this->request->get['tag_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('catalog/tags', 'token=' . $this->session->data['token'] . $url, true);
	...
	public function settings(){
		...
		$data['action'] = $this->url->link('catalog/tags/save_settins', 'token=' . $this->session->data['token'], true);
		...
		$data['breadcrumbs'][] = array(
			'text' => $this->language->get('heading_title'),
			'href' => $this->url->link('catalog/tags', 'token=' . $this->session->data['token'] , true)
		);

		$data['breadcrumbs'][] = array(
			'text' => $this->language->get('heading_title'),
			'href' => $this->url->link('catalog/tags/settings', 'token=' . $this->session->data['token'] , true)
		);

		$data['cancel'] = $this->url->link('catalog/tags', 'token=' . $this->session->data['token'], true);
	...
	public function save_settins() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
			...
			$this->response->redirect($this->url->link('catalog/tags', 'token=' . $this->session->data['token'] , true));
		}

		$this->response->redirect($this->url->link('catalog/settings', 'token=' . $this->session->data['token'] , true));
	}
	...
	public function group(){
		...
		$data['action'] = $this->url->link('catalog/tags/group', 'token=' . $this->session->data['token'] , true);
