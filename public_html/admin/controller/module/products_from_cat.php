...
class ControllerModuleProductsFromCat extends Controller {
	...
	public function index() {
		$this->load->language('module/products_from_cat');
		...
		$data['breadcrumbs'][] = array(
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('module/products_from_cat', 'token=' . $this->session->data['token'], 'SSL'),
   		);
		
		if (!isset($this->request->get['module_id'])) {
			$data['action'] = $this->url->link('module/products_from_cat', 'token=' . $this->session->data['token'], true);
		} else {
			$data['action'] = $this->url->link('module/products_from_cat', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], true);
		}
		...
		$this->response->setOutput($this->load->view('module/products_from_cat.tpl', $data));
	}
	
	protected function validate() {
		if (!$this->user->hasPermission('modify', 'module/products_from_cat')) {
