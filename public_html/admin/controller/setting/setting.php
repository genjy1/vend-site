...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_video_url'])) {
			$data['config_video_url'] = $this->request->post['config_video_url'];
		} elseif($this->config->get('config_video_url') != "") {
			$data['config_video_url'] = $this->config->get('config_video_url');
		} else{
			$data['config_video_url'] = "";
		}
	...
	protected function validate() {
		...
		if ((utf8_strlen($this->request->post['config_telephone']) < 3) || (utf8_strlen($this->request->post['config_telephone']) > 74)) {
