          ...
          <div class="tab-content">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <textarea name="post_description[<?php echo $language['language_id']; ?>][description]" placeholder="<?php echo $entry_description; ?>" id="input-description<?php echo $language['language_id']; ?>" class="form-control ckeditor"><?php echo isset($post_description[$language['language_id']]) ? $post_description[$language['language_id']]['description'] : ''; ?></textarea>
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="date" name="post_date" value="<?php echo $post_date; ?>" id="input-date" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-form">Контактная форма</label>
                <div class="col-sm-10">
                  <input type="checkbox" value="1" name="form" id="input-form" class="form-control" <?php if($form) {?> checked="checked" <?php } ?> />
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-timer"><span data-toggle="tooltip" title="<?php echo $help_timer; ?>">Таймер</span></label>
                <div class="col-sm-10">
                  <input type="date" name="timer" value="<?php echo $timer; ?>" placeholder="<?php echo $entry_timer; ?>" id="input-timer" class="form-control" />
                </div>
              </div>


              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-product"><span data-toggle="tooltip" title="<?php echo $help_product; ?>">Товары</span></label>
                <div class="col-sm-10">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-category"><?php echo $categories_entry; ?></label>
                <!-- <div class="col-sm-10">
                  <select name="category" id="input-category" class="form-control">
                    <option value="0">Select categories </option>
                    <? foreach($categories as $cat) { ?>
                      <option value="<? echo $cat['category_id'] ?>" <? if((int)$category == (int)$cat['category_id']){ ?> selected <? } ?>><? echo $cat['name'] ?></option>
                    <? } ?>
                  </select>
                </div> -->

                <div class="col-sm-10">
                  <input type="text" name="category" value="" placeholder="<?php echo $categories_entry; ?>" id="input-category" class="form-control" />
...
$('input[name=\'category\']').autocomplete({
  ...
  'select': function(item) {
    ...
    $('#post-category').append('<div id="post-category' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="category[]" value="' + item['value'] + '" /></div>');
  }
});
...
$('input[name=\'products\']').autocomplete({
  ...
  'select': function(item) {
    ...
    $('#product').append('<div id="product-related' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="products[]" value="' + item['value'] + '" /></div>');
  }
});
