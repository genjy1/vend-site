  ...
  <div class="container-fluid">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="currency_product"><?php echo $entry_currency; ?></label>
                <div class="col-sm-10">
                  <select name="currency_product" id="currency_product" class="form-control">
                    <?php foreach ($currencies as $currency) { ?>
                    <?php if($current_code == $currency['code']) {?>
            ...
            <div class="tab-pane" id="tab-links">
              ...
              <div id="manuals">
                <? if(isset($manuals) && is_array($manuals) ){ ?>
              <?php foreach($manuals as $key => $manual) { ?>
                <? if($manual == "") continue; ?>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-manual"><span data-toggle="tooltip" title="Ссылка на инструкцию">Ссылка на файл</span></label>
                <div class="col-sm-10">
                  <input type="text" name="manual[]" value="<?php echo $manual ?>" placeholder="" id="input-manual" class="form-control" />
                </div>
              </div>

              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-manual_name"><span data-toggle="tooltip" title="Это название файла будет выводится на сайте">Название</span></label>
                <div class="col-sm-10">
                  <input type="text" name="manual_name[]" value="<?php echo $manual_names[$key] ?>" placeholder="" id="input-manual_name" class="form-control" />
                </div>
              </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-manual"><button type="button" class="btn btn-primary" id="addmanual">Добавить ссылку на инструкцию</button></label>
                <div class="col-sm-10">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label" for="input-variants"><span data-toggle="tooltip" title="<?php echo $help_variants; ?>">Что продают</span></label>
                <div class="col-sm-10">
                  <input type="text" name="variants" value="" placeholder="" id="input-variants" class="form-control" />
                  <div id="product-variants" class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($product_variantss as $product_variants) { ?>
                    <div id="product-variants<?php echo $product_variants['product_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $product_variants['name']; ?>
                      <input type="hidden" name="product_variants[]" value="<?php echo $product_variants['product_id']; ?>" />
                    </div>
                    <?php } ?>
                  </div>
                </div>
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label" for="input-similar"><span data-toggle="tooltip" title="<?php echo $help_similar; ?>">Похожие</span></label>
                <div class="col-sm-10">
                  <input type="text" name="similar" value="" placeholder="" id="input-similar" class="form-control" />
            ...
            <div class="tab-pane" id="tab-image">
              ...
              <div class="table-responsive">
                ...
                <table id="images1" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      <td class="text-left">Установленные</td>
                      <td class="text-right"><?php echo $entry_sort_order; ?></td>
                      <td></td>
                    </tr>
                  </thead>
                  <tbody>
                    <?php foreach ($examples_images as $example_image) { ?>
                    <tr id="image-row<?php echo $image_row; ?>">
                      <td class="text-left"><a href="" id="thumb-image<?php echo $image_row; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo $example_image['thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="example_image[<?php echo $image_row; ?>][image]" value="<?php echo $example_image['image']; ?>" id="input-image<?php echo $image_row; ?>" /></td>
                      <td class="text-right"><input type="text" name="example_image[<?php echo $image_row; ?>][sort_order]" value="<?php echo $example_image['sort_order']; ?>" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>
                      <td class="text-left"><button type="button" onclick="$('#image-row<?php echo $image_row; ?>').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>
                    </tr>
                    <?php $image_row++; ?>
                    <?php } ?>
                  ...
                  <tfoot>
                    <tr>
                      <td colspan="2"></td>
                      <td class="text-left"><button type="button" onclick="addImage1();" data-toggle="tooltip" title="<?php echo $button_image_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
                    </tr>
                  </tfoot>
                </table>
              </div>
   ...
   <!--              <div class="table-responsive">
                <table id="images2" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      <td class="text-left">Что продают</td>
                      <td></td>
                      <td class="text-right"><?php echo $entry_sort_order; ?></td>
                      <td></td>
                    </tr>
                  ...
                  <tbody>
                    <?php foreach ($variants_images as $variant_image) { ?>
                    <tr id="image-row<?php echo $image_row; ?>">
                      <td class="text-left"><a href="" id="thumb-image<?php echo $image_row; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo $variant_image['thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="variant_image[<?php echo $image_row; ?>][image]" value="<?php echo $variant_image['image']; ?>" id="input-image<?php echo $image_row; ?>" /></td>
                      <td class="text-right"><input type="text" name="variant_image[<?php echo $image_row; ?>][text]" value="<?php echo $variant_image['text']; ?>" placeholder="Что продают" class="form-control" /></td>
                      <td class="text-right"><input type="text" name="variant_image[<?php echo $image_row; ?>][sort_order]" value="<?php echo $variant_image['sort_order']; ?>" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>
                      <td class="text-left"><button type="button" onclick="$('#image-row<?php echo $image_row; ?>').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>
                    </tr>
                    <?php $image_row++; ?>
                    <?php } ?>
                  ...
                  <tfoot>
                    <tr>
                      <td colspan="3"></td>
                      <td class="text-left"><button type="button" onclick="addImage2();" data-toggle="tooltip" title="<?php echo $button_image_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
                    </tr>
                  </tfoot>
                </table>
              </div> -->
...
<!-- promo -->
            <div class="tab-pane" id="tab-promo">
             <!--  <div class="form-group">
                <label class="col-sm-2 control-label" for="promo0"><? echo $no_promo ?></label>
                <div class="col-sm-10">
                  <input type="radio" name="promo_id" id="promo0" value="0" class="form-control" <? if(0 == $pselected) { ?>checked<? } ?>>
                </div>
              </div> -->
              <? foreach($plist as $promo) { ?>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="promo<?php echo $promo['id']; ?>">
                <img src="<?php echo $promo['image']; ?>" alt="<?php echo $promo['name']; ?>" title="<?php echo $promo['name']; ?>"/></label>
                <div class="col-sm-10">
                  <input type="checkbox" name="promo_id[]" id="promo<?php echo $promo['id']; ?>" value="<?php echo $promo['id']; ?>" class="form-control" <? if(in_array($promo['id'], $pselected)) { ?>checked<? } ?>>
                  <labael><? echo $promo['name'] ?></labael>
                </div>
              </div>
              <? } ?>
            </div>
<!-- video and 3d -->
            <div class="tab-pane" id="tab-video">
              <div class="form-group">
                <label class="col-sm-2 control-label" for="video"><? echo $text_video ?></label>
                <div class="col-sm-10">
                  <input type="text" name="video" id="video" value="<? echo $video ?>" class="form-control" >
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="v3d"><? echo $text_3d ?></label>
                <div class="col-sm-10">
                  <textarea name="v3d" id="" cols="30" rows="5" class="form-control"><? echo $v3d ?></textarea>
                </div>
              </div>
              <div class="form-group">
                <i><label class="col-sm-12 control-label" for="v3d"><? echo $text_v3dhelp ?></label></i>
              </div>
            </div>
...
// variants
$('input[name=\'variants\']').autocomplete({
  'source': function(request, response) {
    $.ajax({
      url: 'index.php?route=catalog/product/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
      dataType: 'json',
  ...
  'select': function(item) {
    ...
    $('#product-variants' + item['value']).remove();

    $('#product-variants').append('<div id="product-variants' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="product_variants[]" value="' + item['value'] + '" /></div>');
  }
});

$('#product-variants').delegate('.fa-minus-circle', 'click', function() {
  $(this).parent().remove();
});
...
function addImage1() {
  html  = '<tr id="image-row' + image_row + '">';
  html += '  <td class="text-left"><a href="" id="thumb-image' + image_row + '"data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="example_image[' + image_row + '][image]" value="" id="input-image' + image_row + '" /></td>';
  html += '  <td class="text-right"><input type="text" name="example_image[' + image_row + '][sort_order]" value="" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>';
  html += '  <td class="text-left"><button type="button" onclick="$(\'#image-row' + image_row  + '\').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>';
  html += '</tr>';

  $('#images1 tbody').append(html);
...
function addImage2() {
  html  = '<tr id="image-row' + image_row + '">';
  html += '  <td class="text-left"><a href="" id="thumb-image' + image_row + '"data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="variant_image[' + image_row + '][image]" value="" id="input-image' + image_row + '" /></td>';
  html +='<td class="text-right"><input type="text" name="variant_image[' + image_row + '][text]" value="" placeholder="Что продают" class="form-control" /></td>'
  html += '  <td class="text-right"><input type="text" name="variant_image[' + image_row + '][sort_order]" value="" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>';
  html += '  <td class="text-left"><button type="button" onclick="$(\'#image-row' + image_row  + '\').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>';
  html += '</tr>';

  $('#images2 tbody').append(html);
...
$("#addmanual").on("click", function(){
  $("#manuals").append('<div class="form-group"><label class="col-sm-2 control-label" for="input-manual"><span data-toggle="tooltip" title="Ссылка на инструкцию">Ссылка на файл</span></label><div class="col-sm-10"><input type="text" name="manual[]" value="" placeholder="" id="input-manual" class="form-control" /></div> </div><div class="form-group"><label class="col-sm-2 control-label" for="input-manual_name"><span data-toggle="tooltip" title="Это название файла будет выводится на сайте">Название</span></label><div class="col-sm-10"><input type="text" name="manual_name[]" value="" placeholder="" id="input-manual_name" class="form-control" /></div></div>');
});
//--></script>
      ...
      browseButton.onClick = function() {
        ...
        $.ajax({
          ...
          success: function(html) {
            $('body').append('<div id="modal-image" class="modal cke_eval" style="z-index: 99999;">' + html + '</div>');
