                ...
                <table id="images" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr id="image-row<?php echo $image_row; ?>">
                      <td class="text-center"><a href="" id="thumb-image<?php echo $image_row; ?>" data-toggle="image" class="img-thumbnail">
                        <img src="<?php echo $value['thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" />
                    </a><input type="hidden" name="value[<?php echo $image_row; ?>][value]" value="<?php echo $value['value']; ?>" id="input-image<?php echo $image_row; ?>" /></td>
                      ...
                      <td>
                        <textarea name="value[<?php echo $image_row; ?>][description]" class="form-control"><? echo $value['description'] ?></textarea>
                      </td>
...
function addImage() {
  ...
  html += '  <td class="text-center"><a href="" id="thumb-image' + image_row + '"data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="value[' + image_row + '][value]" value="" id="input-image' + image_row + '" /></td>';
  ...
  html += '<td>';
  html += '<textarea name="value[' + image_row + '][description]" class="form-control"></textarea>';
  html += '</td>';
