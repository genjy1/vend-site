    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-option" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-option-group"><?php echo $entry_option_group; ?></label>
            <div class="col-sm-10">
              <select name="option_group_id" id="input-option-group" class="form-control">
                <option value="0">Select group</option>
                <?php foreach ($option_groups as $option_group) { ?>
                <?php if ($option_group['option_group_id'] == $option_group_id) { ?>
                <option value="<?php echo $option_group['option_group_id']; ?>" selected="selected"><?php echo $option_group['name']; ?></option>
                <?php } else { ?>
                <option value="<?php echo $option_group['option_group_id']; ?>"><?php echo $option_group['name']; ?></option>
                <?php } ?>
                <?php } ?>
              </select>
            </div>
          ...
          <table id="option-value" class="table table-striped table-bordered table-hover">
            <thead>
              <tr>
                ...
                <td class="text-left required">Описание</td>
            ...
            <tbody>
              ...
              <tr id="option-value-row<?php echo $option_value_row; ?>">
                ...
                <td class="text-left"><input type="hidden" name="option_value[<?php echo $option_value_row; ?>][option_value_id]" value="<?php echo $option_value['option_value_id']; ?>" />
                  <?php foreach ($languages as $language) { ?>
                  <div class="input-group"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
                    <input type="text" name="option_value[<?php echo $option_value_row; ?>][option_value_description][<?php echo $language['language_id']; ?>][description]" value="<?php echo isset($option_value['option_value_description'][$language['language_id']]) ? $option_value['option_value_description'][$language['language_id']]['description'] : ''; ?>" placeholder="description" class="form-control" />
                  </div>
                  <?php } ?></td>
...
function addOptionValue() {
  ...
  <?php foreach ($languages as $language) { ?>
  html += '    <div class="input-group">';
  html += '      <span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span><input type="text" name="option_value[' + option_value_row + '][option_value_description][<?php echo $language['language_id']; ?>][description]" value="" placeholder="" class="form-control" />';
    html += '    </div>';
  <?php } ?>
  html += '  </td>';
