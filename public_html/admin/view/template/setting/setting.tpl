          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="config_video_url">Video review url</label>
                <div class="col-sm-10">
                  <input type="text" name="config_video_url" value="<?php echo $config_video_url; ?>" placeholder="" id="config_video_url" class="form-control" />
                </div>
              </div>
