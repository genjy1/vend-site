<ul id="menu">
  ...
  <li id="catalog"><a class="parent"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_catalog; ?></span></a>
    <ul>
      ...
      <li><a href="<?php echo $spares; ?>"><?php echo $text_spares; ?></a></li>
  ...
  <li id="extension"><a class="parent"><i class="fa fa-puzzle-piece fa-fw"></i> <span><?php echo $text_extension; ?></span></a>
    <ul>
      ...
      <li><a href="<?php echo $sub; ?>"><?php echo $text_sub; ?></a></li>
      ...
      <?php } ?>
      <li>
        <a href="<?php echo $youtube ?>"><?php echo $text_youtube ?></a>
      </li>
    </ul>
  </li>
  ...
  <li id="push">
    <a class="parent"><i class="fa fa-television fa-fw"></i> <span><?php echo $text_push; ?></span></a>
    <ul>
      <li>
        <a href="<?php echo $push?>"><i class="fa fa-bell fa-fw"></i> <span><?php echo $text_push; ?></span></a>
      </li>
      <li>
        <a href="<?php echo $push_history?>"><i class="fa fa-history fa-fw"></i> <span><?php echo $text_push_history; ?></span></a>
      </li>
      <li>
        <a href="<?php echo $mail_history?>"><i class="fa fa-history fa-fw"></i> <span><?php echo $text_mail_history; ?></span></a>
      </li>
    </ul>
  ...
  <li id="onlinevendshop"><a href="<?php echo $onlinevendshop; ?>"><i class="fa fa-cloud-upload fa-fw"></i> <span>Online Vendshop</span></a></li>
</ul>
