...
1. Скопируйте содержимое архива  (папку retailcreditservice) в корень веб-сервера.
...
<div style="float:left;">
    <a title="Купить в кредит" onclick="productAddToCartForm.submit(this);retailcreditdialog();)" href="javascript:;">
        <img src="retailcredit/images/retailcreditbuy.png">
    </a>
</div>

   Для правильной работы формы, в качестве аргумента в retailcreditdialog необходимо
   передать следующие данные в формате JSON: название товара, количество, цена в таком виде:

   retailcreditdialog([{MODEL: "Apple iPhone 4S 16GB", COUNT:"1", PRICE:"10000"},{MODEL: " Чехол для Apple iPhone 4S", COUNT:"1", PRICE:"500"}],2);
...
<div style="float:left;">
   ...
   <?php
    ...
    ?>
    <div style="float:left;">
    <a title="Купить в кредит" onclick='productAddToCartForm.submit(this);retailcreditdialog("<? json_encode($args); ?>",2);'
     href="javascript:;">
        <img src="add-to-cart-btn.png">
    </a>
</div>
...
Второй параметр функции retailcreditdialog, равен:
