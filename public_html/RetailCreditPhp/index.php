    ...
    <table style="font-family: Arial, Helvetica, sans-serif; font-size: 14px">
                ...
                <table width="100%">
                        <tr>
                            <td align="center" valign="top">
                                ...
                                <div style="font-size:13px">Код</div>
                            </td>
                            <td align="center" valign="top">
        ...
        <tr>
            <td align="left" valign="top">
                Согласен с <a target="_blank" href="http://retail-credit.ru/agreement.htm">условиями Соглашения</a>
            </td>
            <td>
        ...
        <tr>
			...
			<input type="submit" name="sub_form" value=" " style="background:url(retailcredit/images/retailcreditsend.png) no-repeat; width:187px; height:31px; border:0;" >
            </td>
        </tr>
    </table>
