...
class ControllerExtensionModuleRecaptcha extends Controller {
    ...
    public function validateCaptcha() {
        ...
        error_log("Ответ от Google reCAPTCHA: " . $recaptcha_response);
        ...
        if ($recaptcha_data['success']) {
            ...
            $error_codes = isset($recaptcha_data['error-codes']) ? $recaptcha_data['error-codes'] : [];

//            $this->response->addHeader('Content-Type: application/json');
//            $this->response->setOutput(json_encode([
//                'success' => false,
//                'errors' => $error_codes // Добавляем коды ошибок
//            ]));
        }
    }
}
