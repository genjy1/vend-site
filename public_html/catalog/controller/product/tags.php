      ...
      $data['avtomat'] = true;
			...
			foreach ($results as $result) {
				if ($result['image']) {
					...
					$image = $this->model_tool_image->resize('placeholder.png', $this->config->get('theme_default_product_width'), $this->config->get('theme_default_product_height'));
				}
	...
	public function ajax() { 
		...
		if ($tag_info) {
			...
			$data['sorts'][] = array(
				'text'  => $this->language->get('text_default'),
				'value' => 'p.sort_order-ASC',
				'href'  => $this->url->link('product/tags', 'tag_id=' . $tag_id . '&sort=p.sort_order&order=ASC' . $url,true)
			);

			$data['sorts'][] = array(
				'text'  => $this->language->get('text_name_asc'),
				'value' => 'pd.name-ASC',
				'href'  => $this->url->link('product/tags', 'tag_id=' . $tag_id . '&sort=pd.name&order=ASC' . $url,true)
			);

			$data['sorts'][] = array(
				'text'  => $this->language->get('text_name_desc'),
				'value' => 'pd.name-DESC',
				'href'  => $this->url->link('product/tags', 'tag_id=' . $tag_id . '&sort=pd.name&order=DESC' . $url,true)
			);

			$data['sorts'][] = array(
				'text'  => $this->language->get('text_price_asc'),
				'value' => 'p.price-ASC',
				'href'  => $this->url->link('product/tags', 'tag_id=' . $tag_id . '&sort=p.price&order=ASC' . $url,true)
			);

			$data['sorts'][] = array(
				'text'  => $this->language->get('text_price_desc'),
				'value' => 'p.price-DESC',
				'href'  => $this->url->link('product/tags', 'tag_id=' . $tag_id . '&sort=p.price&order=DESC' . $url,true)
			);
			...
			if ($this->config->get('config_review_status')) {
				$data['sorts'][] = array(
					'text'  => $this->language->get('text_rating_desc'),
					'value' => 'rating-DESC',
					'href'  => $this->url->link('product/tags', 'tag_id=' . $tag_id . '&sort=rating&order=DESC' . $url,true)
				);

				$data['sorts'][] = array(
					'text'  => $this->language->get('text_rating_asc'),
					'value' => 'rating-ASC',
					'href'  => $this->url->link('product/tags', 'tag_id=' . $tag_id . '&sort=rating&order=ASC' . $url,true)
				);
			}
			...
			$data['sorts'][] = array(
				'text'  => $this->language->get('text_model_asc'),
				'value' => 'p.model-ASC',
				'href'  => $this->url->link('product/tags', 'tag_id=' . $tag_id . '&sort=p.model&order=ASC' . $url,true)
			);

			$data['sorts'][] = array(
				'text'  => $this->language->get('text_model_desc'),
				'value' => 'p.model-DESC',
				'href'  => $this->url->link('product/tags', 'tag_id=' . $tag_id . '&sort=p.model&order=DESC' . $url,true)
			);
			...
			foreach($limits as $value) {
				$data['limits'][] = array(
					'text'  => $value,
					'value' => $value,
					'href'  => $this->url->link('product/tags', 'tag_id=' . $tag_id . $url . '&limit=' . $value,true)
				);
			}
			...
			$pagination->page = $page;
			$pagination->limit = $limit;
			$pagination->url = $this->url->link('product/tags', 'tag_id=' . $tag_id . $url . '&page={page}',true);
			...
			$this->response->setOutput($this->load->view('product/tags_ajax', $data));
