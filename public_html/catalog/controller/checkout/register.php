...
class ControllerCheckoutRegister extends Controller {
	...
	public function save() {
		...
		if (!$json) {
			...
			if ((utf8_strlen(trim($this->request->post['patronymic'])) < 1) || (utf8_strlen(trim($this->request->post['patronymic'])) > 32)) {
				$json['error']['patronymic'] = $this->language->get('error_patronymic');
			}
		...
		if(isset($json['registered']) && $json['registered']){
