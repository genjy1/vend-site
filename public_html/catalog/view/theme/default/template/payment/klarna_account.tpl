...
<?php } ?>
<p><img class="lazy" data-src="https://cdn.klarna.com/public/images/<?php echo $iso_code_2; ?>/badges/v1/account/<?php echo $iso_code_2; ?>_account_badge_std_blue.png?width=150&eid=<?php echo $merchant; ?>" /></p>
  ...
  <fieldset>
    ...
    <div class="radio">
      <label>
        ...
        <img class="lazy" data-src="catalog/view/theme/default/image/klarna_nld_banner.png" />
        <?php } ?>
