  ...
  <div class="product" id="product">
    ...
    <div class="block1">
      <div class="fullimage">
        ...
        <? } ?>
        <a href="<? echo $popup ?>" class="fullfanc" data-fancybox="fullfancy" rel="fullfanc" data-popup2="<? echo $popup2 ?>"><img class="lazy" data-src="<?php echo $thumb; ?>"></a>
        <? if(isset($promo) && !empty($promo)) {?>
        <? foreach($promo as $prom){ ?>
        <div class="promo" style="<? echo $prom['position']; ?>">
          <img class="lazy" data-src="<? echo $prom['image']; ?>" alt="">
  ...
  <?php } ?>
        ...
        <div class="whatsale">
          ...
          <div id="whats">
            ...
            <div class="item"><a href="<? echo $variant['href'] ?>"><img class="lazy" data-src="<? echo $variant['thumb'] ?>">
