    ...
    <? $args = array(); ?>
      ...
      <div class="cart">
        ...
        <div class="cartform">
          ...
          <div class="item">
           <div class="head">
            <div class="col1">Наименование товара</div>
          </div>
            <div class="col2">
            ...
            <div>
              ...
              <label for="r<?php echo $product['cart_id']; ?><?php echo $option_value['product_option_value_id']; ?>"><span></span><?php echo $option_value['name']; ?><? if($option_value['description'] != ''){ ?>
              <a class="inf"></a>
              <? } ?>
               <div class="popupopt">
            ...
            <div>
              ...
              <label for="c<?php echo $product['cart_id']; ?><?php echo $option_value['product_option_value_id']; ?>"><?php echo $option_value['name']; ?><? if($option_value['description'] != ''){ ?>
              <a class="inf"></a>
              <? } ?>
               <div class="popupopt">
                  <div><img class="lazy" data-src="<? echo $option_value['image'] ?>" alt=""></div>
            ...
            <div class="col3">
            <div class="head">
              <div class="col1">Количество, шт</div>
            </div>
              <div class="qch">
