  ...
  <div class="product" id="product">
    ...
    <div class="block1">
      ...
      <div class="fullimage">
        ...
        <? } ?>
        <a href="<? echo $popup ?>" data-fancybox="fullfancy" rel="fullfanc" data-popup2="<? echo $popup2 ?>"><img src="<?php echo $thumb; ?>"></a>
      ...
      <div class="images">
        ...
        <div>
            <a href="<? echo $image['popup'] ?>" rel="fullfanc" <?php if($key != 0) { ?> data-fancybox="fullfancy" <?php } ?> >
                <img data-popup="<? echo $image['popup'] ?>" data-popup2="<? echo $image['popup2'] ?>" src="<? echo $image['thumb'] ?>">
            </a>
        </div>
        <? } ?>
      </div>
      ...
      <div class="price">
        ...
        <? } else{ ?>
        <? if($avtomat) {?>
        <a href="javascript:void(0)" class="getoffer" style="margin-top: 20px; line-height: 50px;padding-top: 0">получить индивидуальное предложение</a>
        <a class="request buy-kredit" style="float: right !important; margin-top: 20px; line-height: 50px">Купить в кредит</a>
        <? } else { ?>
        <? if($category_id == 3) { ?>
        ...
        <? } ?>
        <? } ?><br>
        <a class="getlis" id="getLis" href="#lising-box" data-width="600" style="margin-top: 20px; margin-left: 0; display: none">Лизинг</a>
  ...
  'count': 1,
    ...
    <div class="block2">
      ...
      <div class="total">
        ...
        <!--  <a href="javascript:void(0)" class="getoffer">Лизинг</a> -->
        <? } else { ?>
        <? if($category_id == 3) { ?>
    ...
    <div class="block3">
        ...
        <div class="left">
          ...
          <div class="right examples">
            ...
            <div class="items owl-carousel owl-theme" id="ex">
              ...
              <div class="item">
                <a href="<?php echo $product['full'] ?>" data-fancybox="installed" class="fanc" rel="example_group"><img src="<?php echo $product['thumb']; ?>" alt="" title=""></a>
              </div>
              <? } ?>
            </div>
          </div>
      ...
      <div class="block4">
        ...
        <div class="productfeature">
          ...
          <div class="cont">
            ...
            <div class="ind" id="ind">
              ...
              <? if($it > 3) break; ?>
              <div class="item"><a href="<? echo $product['href']; ?>">
        ...
        <?php } ?>
        <?php if(isset($products["related"]) && $products["related"]) { ?>
    <div class="productfeature">
  ...
  <?php } ?>
       ...
       <div class="comments">
        ...
        <script type="text/javascript">
          VK.Widgets.Comments("vk_comments", {limit: 15, width: "720", attach: false});
        </script>
      </div>
      <div class="catdesc">
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    window.addEventListener('scroll', function() { $(".popupopt").hide(); });

    $(".product .switchoptions div").on("click", function(e){
      // e.stopPropagation();
      $(".popupopt").hide();
    })
...
<script type="text/javascript">
  ...
  $('.switchoptions input').on('change', function(){
    $.ajax({
      ...
      success: function(json) {
        console.log(json);
        $('.cart #totals, #totalprice').text(json.price);
