        ...
        <? if(isset($maps) && !empty($maps) && count($maps) > 1) { ?>
          <div class="mini">
            <?php foreach ($maps as $value) { ?>
              <div class="item">
                <img src="<? echo $value['mini'] ?>" alt="" data-id="<? echo $value['map_id'] ?>">
              </div>
            <? } ?>
          </div>
          <? } ?>
                        ...
                        <div class="item" data-mapid="<? echo $value['map_id'] ?>_<? echo $item['product_id'] ?>">
                          ...
                          <div class="img">
                            <a href="<? echo $item['bigimage'] ?>" class="fancy">
                              <img src="<? echo $item['image'] ?>">
                            </a>
                          </div>
                          <div class="title"> 
                            <div class="name"><? echo utf8_substr(strip_tags(html_entity_decode($item['name'] , ENT_QUOTES, 'UTF-8')), 0, 60) ?></div>
                            <div class="descr">
