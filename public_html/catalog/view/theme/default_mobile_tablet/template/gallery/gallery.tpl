...
<div id="gallery-set">
          <? foreach($images as $image){ ?>
              <img src="<? echo $image['thumb'] ?>" alt="<? echo $image['title'] ?>" data-image="<? echo $image['image'] ?>" data-description="<? echo $image['title'] ?>" <? if($image['videoid']!=''){ ?>data-type="youtube" data-videoid="<? echo $image['videoid'] ?>" <? } ?> style="display:none">
          <? } ?>
    </div>
<?php echo $pagination ?>
