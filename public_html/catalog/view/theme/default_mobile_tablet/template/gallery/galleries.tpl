...
.windows8{
  ...
  <? foreach($galleries as $gallery){ ?>
    <div> 
      <a href="<? echo $gallery['href'] ?>"><img width="100%"  src="<? echo $gallery['image'] ?>"  alt="">
...
<script>
$(".galery-content > div").css({'opacity':0});
  $(window).load(function(){
    $(".galery-content > div").map(function(){
      h = $(this).find('img').height();
      // alert(h);
      $(this).height(h);
    });
    $(".windows8").hide();
    $(".galery-content > div").css({'opacity':1});
  });
</script>
